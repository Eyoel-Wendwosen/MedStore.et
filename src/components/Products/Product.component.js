...
class Product extends Component {
	...
	addProductToCompare(product) {
		if (this.state.productsToCompare.length >= 10 || this.state.productsToCompare.filter(prod => prod._id == product._id).length != 0) {
			return 1;
		}
			...
			<>
				<div className="product-content">
					...
					<Switch>
						...
						/>
						<Route
							path={[`${this.props.match.url}/subCategory/:subCategory/detail/:productId`, `${this.props.match.url}/category/:category/detail/:productId`, `${this.props.match.url}/search/detail/:productId`, `${this.props.match.url}/compare/detail/:productId`]}
							render={props => <ProductDetail onAddToCompare={this.addProductToCompare} {...props} />}
						/>
						<Route
							path={`${this.props.match.url}/compare`}
							render={props => <ProductCompare products={this.state.productsToCompare} {...props} />}
						/>
					</Switch>
